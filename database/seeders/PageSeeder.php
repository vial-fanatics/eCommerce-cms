            ...
            'en_US' => [
                [
                    ...
                    'content'  =>
                        ...
                        Html::tag('div', '[flash-sale title="Deal of the day" subtitle="Best Deals For You" show_popup="yes"][/flash-sale]') .
                        Html::tag('div',
                        ...
                        Html::tag('div', '[theme-galleries title="@ OUR GALLERIES" subtitle="Our latest fashion galleries images" limit="8"][/theme-galleries]') .
                        Html::tag('div', '[site-features icon1="icon-truck" title1="FREE SHIPPING" subtitle1="Free shipping on all US order or order above $200" icon2="icon-life-buoy" title2="SUPPORT 24/7" subtitle2="Contact us 24 hours a day, 7 days a week" icon3="icon-refresh-ccw" title3="30 DAYS RETURN" subtitle3="Simply return it within 30 days for an exchange" icon4="icon-shield" title4="100% PAYMENT SECURE" subtitle4="We ensure secure payment with PEV"][/site-features]')
                    ,
                    'template' => 'homepage',
                ],
                [
            ...
            'vi'    => [
                [
                    ...
                    'content'  =>
                        ...
                        Html::tag('div', '[flash-sale title="Khuyến mãi hôm nay" subtitle="Khuyến mãi tốt nhất dành cho bạn" show_popup="yes"][/flash-sale]') .
                        Html::tag('div',
                        ...
                        Html::tag('div', '[theme-galleries title="@ Thư viện ảnh" subtitle="Hình ảnh phòng trưng bày thời trang mới nhất của chúng tôi" limit="8"][/theme-galleries]') .
                        Html::tag('div', '[site-features icon1="icon-truck" title1="MIỄN PHÍ VẬN CHUYỂN" subtitle1="Giao hàng miễn phí cho tất cả các đơn đặt hàng tại Hoa Kỳ hoặc đơn hàng trên $200" icon2="icon-life-buoy" title2="HỖ TRỢ 24/7" subtitle2="Liên hệ với chúng tôi 24 giờ một ngày, 7 ngày một tuần" icon3="icon-refresh-ccw" title3="30 HOÀN HÀNG" subtitle3="Hỗ trợ trả hàng trong vòng 30 ngày" icon4="icon-shield" title4="100% THANH TOÁN BẢO MẬT" subtitle4="Chúng tôi đảm bảo thanh toán an toàn với PEV"][/site-features]')
                    ,
                    'template' => 'homepage',
                ],
                [
